...
- [First](phase-1.md) phase. `COMPLETE`
    - **Hardware exploration**.
    - CHIP-8 virtual machine.
	- MC6809 CPU platform.
	- [DREAM6800](http://www.mjbauer.biz/DREAM6800.htm) SBC.

- [Second](phase-2.md) phase. `COMPLETE`
    - **Settled on hardware**.
	- Basic 6502 setup.
	- Microcontroller-based video.

- [Third](phase-3.md) phase. `CLOSED`
...
- [2025-06-22](../log/2025-06-22-project-refresh.md) - Project Refresh.

- [2024-12-04](../log/2024-12-04-mcu-analysis.md) - Microcontroller Video Out.

- [2024-11-28](../log/2024-11-28-start-phase-2.md) - Project Start Phase 2.
